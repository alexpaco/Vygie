 ...
 var departements = {
 	...
 	D2A: {
 		...
 		nom:"Corse-du-Sud",
 		lien: "",
 		points:"415,443, 429,452, 437,467, 443,466, 442,477, 438,488, 423,479, 422,463, 415,462",
 	},
 	D2B :{
 		nom:"Haute-Corse",
 		lien: "",
 		points: "440,409, 441,427, 446,437, 446,447, 443,463, 437,463, 431,450, 428,447, 415,441, 416,435, 418,433, 429,426, 437,424, 437,411",
 	},
 	D21 :{
 		nom:"Côte-d'Or",
 		lien: "",
 ...
 function francefree(){
var carte = '';
carte += '<link rel="stylesheet" href="css/style.css" type="text/css" media="screen" />';
carte += '<script src="https://code.jquery.com/jquery-1.11.1.min.js" integrity="sha256-VAvG3sHdS5LqTT+5A/aeq/bZGa/Uj04xKxY8KM/w9EE=" crossorigin="anonymous"></script>';
carte += '<script src="js/creationCarte.js"></script>';
carte += '<div id="legende"></div><map  id="map" name="map"><div id="areas"></div> </map><img id="canvasMap" id="image" src="img/fondCarte.png" usemap="#map"/><canvas id="canvas">Mettez à jour votre navigateur Internet !</canvas>';
document.write(""+carte+"");
}
$(function(){
        var map = $("#map");
        var areas = $("#areas");
